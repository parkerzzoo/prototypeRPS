...
public class UIControl_BasicMode : Singletone<UIControl_BasicMode>
{
	...
	{
		/*if(FlowControl_BasicMode.Instance.SelectHand(HandType.rock))
        {
			DeselectAllHand();
	...
	{
		/*if (FlowControl_BasicMode.Instance.SelectHand(HandType.paper))
		{
			DeselectAllHand();
	...
	{
		/*if (FlowControl_BasicMode.Instance.SelectHand(HandType.scissors))
		{
			DeselectAllHand();
